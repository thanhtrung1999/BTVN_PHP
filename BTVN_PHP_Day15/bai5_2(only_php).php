...
if(isset($_POST['save'])){
    ...
    if(empty($firstname)){
        ...
        $error = "";
    } else if(empty($confirm) || ($confirm != $password)){
        $error = "";
    } else {
            ...
            <tr>
                ...
                <td>
                    <div class="form-control">
                        ...
                        ?>
                        <input type="password" id="confirm" <?php echo $errorClass;?> name="confirm" placeholder="Confirm Password" value="<?php
                        echo isset($_POST['confirm']) ? $_POST['confirm'] : ''?>"/>
                        <div class="error-under-input">
